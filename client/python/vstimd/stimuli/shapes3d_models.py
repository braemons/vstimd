"""3-D stimuli: cube, sphere, plane, corridor and Gaussian splat scene.
...
class GaussianSplat3DParams:
    ...
    *server's* filesystem. It is checked when the stimulus is created and loaded
    ...
    def to_proto(self) -> shapes3d_pb2.GaussianSplat3DParams:
        return shapes3d_pb2.GaussianSplat3DParams(path=self.path)

    @classmethod
    def from_proto(cls, proto: shapes3d_pb2.GaussianSplat3DParams) -> GaussianSplat3DParams:
