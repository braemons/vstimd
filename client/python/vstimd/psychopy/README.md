# `vstimd.psychopy` — PsychoPy-compatible visual layer
...
`vstimd.Connection`. Property setters translate to calls on
...
`vstimd.psychopy.visual.{Rect,Circle,Window}` against the real
