...
from vstimd_client._proto.vstimd.v1 import conditions_pb2
...
class ConditionsClient:
    ...
    Accessed as ``conn.conditions`` on a :class:`~vstimd_client.VstimdClient` instance.
    ...
    def set(self, condition: Union[int, str]) -> ServerResponse:
        ...
        An unknown *name* raises :class:`~vstimd_client.InvalidArgumentError` rather
    ...
    def declare(self, conditions: Iterable[ConditionSpec]) -> ServerResponse:
        ...
        conditions:
            ...
            :class:`~vstimd_client.InvalidArgumentError`.
        """
