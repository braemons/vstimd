...
Every RPC goes through :meth:`vstimd_client.VstimdClient._send`, which turns a non-OK
:class:`~vstimd_client.response.ErrorCode` into one of the exceptions below. Nothing
...
class VstimdError(Exception):
    ...
    code:
        The :class:`~vstimd_client.response.ErrorCode` the server returned. Defaults
