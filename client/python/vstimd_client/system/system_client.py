...
from vstimd_client._proto.vstimd.v1 import input_pb2, scene3d_pb2
from vstimd_client._proto.vstimd.v1 import color_pb2
...
class SystemClient:
    ...
    Accessed as ``conn.system`` on a :class:`~vstimd_client.VstimdClient` instance.
