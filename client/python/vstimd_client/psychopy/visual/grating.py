...
from vstimd_client.stimuli.color import Color as StimulusColor
from vstimd_client.stimuli.grating_models import _MASK_TO_PROTO, _WAVEFORM_TO_PROTO
from vstimd_client.stimuli.vec import Vec2 as StimulusVec2
