...
class CreateRectRequest(_message.Message):
    ...
    params: RectParams
    def __init__(self, identity: _Optional[_Union[_identity_pb2.StimulusIdentity, _Mapping]] = ..., placement: _Optional[_Union[_transform_pb2.Transform2D, _Mapping]] = ..., params: _Optional[_Union[RectParams, _Mapping]] = ...) -> None: ...

class SetRectSizeRequest(_message.Message):
...
class RectParams(_message.Message):
