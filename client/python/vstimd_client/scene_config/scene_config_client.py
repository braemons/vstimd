...
class SceneConfigClient:
    ...
    Accessed as ``conn.scene_config`` on a :class:`~vstimd_client.VstimdClient` instance.
    ...
    *project* — a directory holding everything a study needs — under its
    ...
    def upload(
        ...
        *,
        ...
        overwrite:
            ...
            raises :class:`~vstimd_client.SceneConfigAlreadyExistsError`.
        apply_now:
    ...
    def save(self, name: str, *, overwrite: bool = False) -> ServerResponse:
        ...
        overwrite:
            ...
            :class:`~vstimd_client.SceneConfigAlreadyExistsError`.
        """
        json = self.retrieve()
