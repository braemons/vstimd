...
:mod:`vstimd_client.stimuli.gaussian_splat_client` — so splatting can be added,
disabled or removed without touching the rest of the 3-D surface. Placement is
the shared :class:`~vstimd_client.stimuli.Transform3D`, in centimetres, like any other
3-D stimulus.
"""
