...
several means you are asked which (`--non-interactive` fails instead of
asking). `--address` fills in what you leave out, so `-a 10.0.1.42` and
`-a tcp://10.0.1.42:5555` mean the same thing. `--json`
