...
The release body is generated by the workflow and carries the install
one-liners. The Raspberry Pi image is not built here: it is
[braemons/rig](https://github.com/braemons/rig)'s, and installs this release
from the apt archive once the archive has picked it up.
