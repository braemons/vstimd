...
from wonderlamp._proto import service_pb2
from wonderlamp.stimuli import StimuliClient
from wonderlamp.system import SystemClient
from wonderlamp.exceptions import (
    WonderlampError,
    HandleNotFoundError,
...
_ERROR_CODE_MAP: dict[int, type[WonderlampError]] = {
