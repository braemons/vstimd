...
from wonderlamp._proto import common_pb2, service_pb2, system_pb2
...
class SystemClient:
    ...
    def set_background(self, r: float, g: float, b: float, a: float = 1.0) -> None:
        req = service_pb2.Request(
            system=service_pb2.SystemTarget(),
            set_background=system_pb2.SetBackground(
    ...
    def set_deferred_mode(self, active: bool, *, cancel: bool = False) -> None:
        req = service_pb2.Request(
            system=service_pb2.SystemTarget(),
            set_deferred_mode=system_pb2.SetDeferredMode(active=active, cancel=cancel),
        )
        self._send(req)
    ...
    def delete_all(self) -> None:
        req = service_pb2.Request(
            system=service_pb2.SystemTarget(),
            delete_all=system_pb2.DeleteAll(),
        )
        self._send(req)
    ...
    def set_all_enabled(self, enabled: bool) -> None:
        req = service_pb2.Request(
            system=service_pb2.SystemTarget(),
            set_all_enabled=system_pb2.SetAllEnabled(enabled=enabled),
        )
        self._send(req)
